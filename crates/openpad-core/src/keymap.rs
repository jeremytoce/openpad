...
pub enum Action {
    ...
    Mic,               // fire the Wispr push-to-talk hotkey (focused window)
...
impl Keymap {
    ...
    pub fn default_map() -> Keymap {
        ...
        // slot 15 unreachable: firmware owns key 16 (MO/TG layer key)
        ...
        // slots 8-10 reserved for repo/worktree/logs pickers (Plan 3);
        // slot 15 unreachable (firmware layer key)
        Keymap { steer, launch }
    }
}
...
mod tests {
    ...
    fn corners_are_approve_interrupt_mic_layer() {
        ...
        assert!(km.action(Layer::Steer, 15).is_none(), "key 16 is firmware-owned");
    }
